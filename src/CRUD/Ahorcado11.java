...
public class Ahorcado11 extends javax.swing.JFrame {
    ...
    public void agregarPalabra(){
        ArrayList<String> go=CRUD.registros.palabras3();
        int cont=0;
        for(String aux: go){
            
            if(cont<15){
               
                msgs[cont]=aux.toUpperCase();
              cont++ ; 
            }
    ...
    public void agregarPista(){
        ArrayList<String> go=CRUD.registros.pistas2();
        int cont=0;
        for(String aux: go){
            ...
            if (bt == btns[i]) {
               ...
               /* if (hola.equals(bye)){
                ...
                if (esta) {
                    ...
                    if (gano) {
                        JOptionPane.showMessageDialog(this, "Congratulations!! your score is: 300");
                        AudioClip aplauso;
    ...
    private void initComponents() {
        ...
        btnImagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CRUD/im1.jpg"))); // NOI18N
        ...
        txtExit.setFont(new java.awt.Font("Copperplate Gothic Bold", 0, 18)); // NOI18N
        ...
        lbTitle.setText("ADVANCED LEVEL");
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(btnImagen, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                            ...
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGap(56, 56, 56)
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addComponent(txtExit, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(192, 192, 192)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnImagen, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel3)
                                .addGap(144, 144, 144)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ahorcado11.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ahorcado11().setVisible(true);
            }
        });
    }
